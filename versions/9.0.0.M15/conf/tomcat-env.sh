...
APP_ENV="/opt/repo/versions/9.0.0.M15/conf/tomcat-env.sh"
JAVA_HOME="/usr/java/latest"
CATALINA_HOME="/opt/repo/versions/9.0.0.M15"
JASPER_HOME="/opt/repo/versions/9.0.0.M15"
CATALINA_TMPDIR="/opt/repo/versions/9.0.0.M15/temp"
CATALINA_BASE="/opt/repo/versions/9.0.0.M15"
JVM_ID="jelastic"
